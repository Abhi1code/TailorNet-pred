...
SMPL_PATH_MALE = os.path.join('model-s', 'smpl', 'basicmodel_m_lbs_10_207_0_v1.0.0.pkl')
SMPL_PATH_FEMALE = os.path.join('model-s', 'smpl', 'basicModel_f_lbs_10_207_0_v1.0.0.pkl')
